...
while 1:
    ...
    masterlistSUBWAY = stua.gtfsSubwayBATCHED([("137", "N", 1, 3, "NONE"), ("137", "N", 2, 3, "NONE"), ("137", "N", 3, 3, "NONE"), ("137", "N", 4, 3, "NONE"), ("137", "N", 5, 3, "NONE"), #0-4
                                     ...
                                     ("640", "N", 1, 9, "NONE"), ("640", "N", 2, 9, "NONE"), ("640", "N", 3, 9, "NONE"), ("640", "N", 4, 9, "NONE"), ("640", "N", 5, 9, "NONE")]) #26-30
    if loading == True:
        percent_update(0.65)
    ...
    #main 8 upt
    bulletfont.render_to(screen, (0.5*width+0.1*sectionfactor*height,5.1*sectionfactor*height),  bulletB(masterlistSUBWAY[21]) , "#d9b411") #BWAY
